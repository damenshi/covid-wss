...
static void secp256k1_scalar_set_b32_halfq(secp256k1_scalar *r, const unsigned char *b16, int *overflow) {
    int over;
    r->d[0] = (uint64_t)b16[15] | (uint64_t)b16[14] << 8 | (uint64_t)b16[13] << 16 | (uint64_t)b16[12] << 24 | (uint64_t)b16[11] << 32 | (uint64_t)b16[10] << 40 | (uint64_t)b16[9] << 48 | (uint64_t)b16[8] << 56;
    r->d[1] = (uint64_t)b16[7] | (uint64_t)b16[6] << 8 | (uint64_t)b16[5] << 16 | (uint64_t)b16[4] << 24 | (uint64_t)b16[3] << 32 | (uint64_t)b16[2] << 40 | (uint64_t)b16[1] << 48 | (uint64_t)b16[0] << 56;
    r->d[2] = 0;
    r->d[3] = 0;
    over = secp256k1_scalar_reduce(r, secp256k1_scalar_check_overflow(r));
    if (overflow) {
