/* src/libucake-config.h.  Generated from libucake-config.h.in by configure.  */
/* src/libucake-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this symbol to enable the Pedersen / zero knowledge bulletproof
   module */
/* #undef ENABLE_MODULE_BULLETPROOF */
...
/* Name of package */
#define PACKAGE "libucake"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "libucake"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libucake 0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libucake"
