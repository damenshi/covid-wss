...
static void secp256k1_scalar_set_b32_halfq(secp256k1_scalar *r, const unsigned char *b16, int *overflow) {
    int over;
    r->d[0] = (uint32_t)b16[15] | (uint32_t)b16[14] << 8 | (uint32_t)b16[13] << 16 | (uint32_t)b16[12] << 24;
    r->d[1] = (uint32_t)b16[11] | (uint32_t)b16[10] << 8 | (uint32_t)b16[9] << 16 | (uint32_t)b16[8] << 24;
    r->d[2] = (uint32_t)b16[7] | (uint32_t)b16[6] << 8 | (uint32_t)b16[5] << 16 | (uint32_t)b16[4] << 24;
    r->d[3] = (uint32_t)b16[3] | (uint32_t)b16[2] << 8 | (uint32_t)b16[1] << 16 | (uint32_t)b16[0] << 24;
    r->d[4] = 0;
    r->d[5] = 0;
    r->d[6] = 0;
    r->d[7] = 0;
